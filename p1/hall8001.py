...
max_lunghezza_linea = 15

# Filtriamo le domande che sono troppo lunghe/corte
domande_brevi_temp : list = []
risposte_brevi_temp : list = []

i = 0
for domanda in lista_domande_pulite:
    if len(domanda.split()) >= min_lunghezza_linea and len(domanda.split()) <= max_lunghezza_linea:
        domande_brevi_temp.append(domanda)
        risposte_brevi_temp.append(lista_risposte_pulite[i])
    i += 1

# Filtro delle risposte che sono troppo lunghe/brevi
lista_domande_brevi = []
lista_risposte_brevi = []

i = 0
for risposta in risposte_brevi_temp:
    if len(risposta.split()) >= min_lunghezza_linea and len(risposta.split()) <= max_lunghezza_linea:
        lista_risposte_brevi.append(risposta)
        lista_domande_brevi.append(domande_brevi_temp[i])
    i += 1
...
#trainer.train(lista_domande_brevi)
trainer.train(
